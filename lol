...
ScreenGui.main.Position = UDim2.new(0.562799121, 0, 0.280097491, 0)
ScreenGui.main.Size = UDim2.new(0, 166, 0, 295)
...
ScreenGui.title.Size = UDim2.new(0, 166, 0, 41)
ScreenGui.title.Font = Enum.Font.Gotham
ScreenGui.title.Text = "AdminJoy V2(moded)"
...
wait(2)
system("[System]: Thank you for using AdminJoy V2!")
wait(2)
system("[System]: Enjoy!")
